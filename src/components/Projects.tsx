              ...
              {projects.filter(p => p.featured).map((project, index) => (
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    {/* Tech Stack */}
                    <motion.div 
                      className="flex flex-wrap gap-2 mb-6 text-center justify-center"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
            ...
            {projects.filter(p => !p.featured).map((project, index) => (
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <motion.p 
                    className="text-foreground/70 text-sm mb-4 line-clamp-2 flex-grow"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
            ...
            >
              ...
              >
                ...
                <div className="p-6 overflow-y-auto max-h-[calc(85vh-15rem)]">
                  ...
                  >
                    <motion.h4 
                      className="text-lg font-medium mb-2 flex items-center gap-2 text-left"
                      initial={{ opacity: 0, x: -10 }}
                      animate={{ opacity: 1, x: 0 }}
                    ...
                    <motion.ul 
                      className="list-disc list-inside space-y-2 text-foreground/70 pl-2 text-left"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                    ...
                    >
                      ...
                      >
                        Built with {selectedProject.tags.join(', ')}
                      </motion.li>
                      <motion.li
                        initial={{ opacity: 0, x: -5 }}
                        animate={{ opacity: 1, x: 0 }}
                ...
                <motion.div 
                  className="p-4 border-t border-foreground/10 flex justify-end gap-4"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
